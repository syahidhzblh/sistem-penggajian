                ...
                <form>
                    <div class="form-inline">
                        ...
                        <a href="{{ route('roles.create') }}"
                            class="btn btn-primary app-shadow d-none d-md-inline-block ml-auto text-white">
                            ...
                            <table id="datatable" class="table table-hover table-striped ">
                                ...
                                <tbody>
                                    @foreach ($roles as $item)
                                        <tr id="hide{{ $item->id }}">
                                            <td class="text-left">
                                                <a href="#" class="text-secondary nav-link p-0" title="Lihat opsi"
                                                    data-toggle="dropdown" aria-expanded="false"><i
                                                        class="fa fa-ellipsis-v"></i></a>
                                                <div class="dropdown-menu text-center">
                                                    <a href="{{ route('roles.edit', $item->id) }}"
                                                        class="text-secondary mx-2" data-toggle="tooltip" title="Edit"><i
                                                            class="fa fa-edit"></i></a>
                                                    <a href="javascript:void(0)" onClick="hapus({{ $item->id }})"
                                                        class="text-secondary ml-2" data-toggle="tooltip" title="Hapus"><i
